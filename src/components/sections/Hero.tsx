      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-1 grid-rows-[auto_auto] lg:grid-cols-[4fr_1fr] lg:grid-rows-1 gap-3 min-h-[90vh]">
          ...
          <div className="flex flex-col relative z-10">
            ...
            <div className="flex-1 pt-18 text-black">
              <div className="font-extrabold leading-tight">
                ...
                <div className="pl-8 text-[3rem] md:text-[3.8rem] lg:text-[4.7rem] font-extrabold">
                  Transform
                </div>

                <div className="inline-block pl-24 text-[3rem] md:text-[3.8rem] lg:text-[4.7rem] font-extrabold text-white bg-[#ff9502] bg-clip-div">
                  Your Digital
                </div>
                ...
                <div className="flex items-end pl-16 gap-5 mt-2">
                  ...
                  <div className="text-[3rem] md:text-[3.8rem] lg:text-[4.7rem] font-extrabold">
                    Presence
                  </div>
                </div>
              </div>
              ...
              <div className=" flex pb-2">
                <div className="w-full flex items-center justify-center">
                  <button className="group flex items-center gap-2 px-8 py-4 bg-black text-white rounded-full text-sm font-medium transition-all duration-300 hover:bg-[#FFD700] hover:text-black">
                    Get Started
            ...
            <div className="grid grid-cols-4 min-h-[220px] relative rounded-2xl">
              ...
              {/* STAT 1 */}
              <div className="bg-[#FFFACD] flex flex-col justify-center text-right pr-4 relative rounded-tl-2xl rounded-bl-2xl">
                ...
                <div className="text-sm text-black">Successful Projects</div>
              </div>

              {/* STAT 2 */}
              <div className="bg-[#f39005] flex flex-col justify-center text-right pr-4 relative">
              ...
              {/* STAT 3 */}
              <div className="bg-[#FFD700] flex flex-col justify-center text-right pr-4 relative">
              ...
              {/* IMAGE */}
              <div className="bg-[#FFFACD] relative overflow-visible">
          ...
          <div className="flex flex-row lg:flex-col relative z-0">
            ...
            {/* RIGHT STAT 1 */}
            <div className="flex-1 bg-[#ff9617] flex flex-col justify-center text-right pr-4 relative min-h-[200px] rounded-bl-2xl rounded-tl-2xl lg:rounded-tl-2xl lg:rounded-tr-2xl lg:rounded-br-none">
