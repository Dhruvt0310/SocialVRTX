...
const testimonials = [
  {
    ...
    image: "/img.png",
    text:
      "More than just a service provider, this agency has become a vital part of our team! Their tailored marketing strategies have not only increased our sales but have also enhanced our overall brand strategy. We're thrilled with the growth and look forward to continuing this partnership!",
  },
  {
    name: "Michael Chen",
    ...
    image: "/img.png",
    text:
      "Working with this agency transformed our entire digital strategy. The results exceeded our expectations and the team was professional throughout the entire process. The technical implementation was flawless.",
  },
  {
    name: "Emily Davis",
    ...
    image: "/img.png",
    text:
      "Their creative approach and attention to detail made all the difference. Our brand identity is now stronger than ever and resonates perfectly with our target audience. Highly recommended!",
  },
  {
    name: "David Wilson",
    ...
    image: "/img.png",
    text:
      "Even after project completion, their support has been outstanding. They truly care about our success and continue to provide valuable insights. A true partnership approach.",
  },
  {
    name: "Lisa Thompson",
    ...
    image: "/img.png",
    text:
      "Every recommendation was backed by data and focused on ROI. We saw a 300% increase in conversions within the first quarter after launch. Results speak for themselves!",
  },
  {
    ...
    image: "/img.png",
    text:
      "They don't just work for you, they work with you. The collaborative approach made us feel like we had an extended team of experts. Our new platform handles 10x more traffic!",
  },
];
...
export default function Testimonials() {
  ...
  /* ✅ AUTO SLIDE (STABLE, NO DEP ARRAY CHANGES) */
  useEffect(() => {
    startAutoSlide();
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="flex items-center justify-center gap-8">
            ...
            <div className="relative max-w-2xl w-full flex flex-col items-center">
              {/* Third Card */}
              <div className="absolute inset-0 translate-y-8 left-1/2 -translate-x-1/2 w-[92%] -z-20">
              ...
              {/* Second Card */}
              <div className="absolute inset-0 translate-y-4 left-1/2 -translate-x-1/2 w-[96%] -z-10">
