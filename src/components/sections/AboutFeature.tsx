...
export default function AboutFeature() {
  ...
  return (
    <section
      className={`${manrope.className} relative overflow-hidden bg-[#e9ebef] text-[#060a1b]`}
    >
      <div className="mx-auto max-w-[1560px] px-12 pt-10 pb-16 md:px-16 md:pt-12 md:pb-20 lg:px-24 lg:pt-14 lg:pb-24">
        <div className="grid min-h-[620px] grid-cols-1 gap-14 lg:grid-cols-[minmax(0,1fr)_220px] lg:gap-8">
          <div className="relative z-10">
            ...
            <div className="mt-20 grid grid-cols-1 gap-10 lg:grid-cols-[minmax(780px,1fr)_minmax(200px,240px)_minmax(200px,240px)] lg:items-start lg:gap-12">
              <div className="max-w-none space-y-8 lg:pl-10">
                <div className="flex items-center gap-4"></div>

                <p className="max-w-none text-[1.5rem] font-normal leading-[1.38] tracking-[-0.015em] text-[#303544]">
                  We are on a mission to change the way brands approach social
                  media. We help businesses of all sizes move away from
                  outdated, inconsistent marketing and build a presence that is
                  clear, strategic, and impactful.
                </p>
                <p className="max-w-none text-[1.5rem] font-normal leading-[1.38] tracking-[-0.015em] text-[#303544]">
                  Our focus is simple, to make social media work the way it's
                  supposed to and use it as a powerful tool for visibility,
                ...
                <button className="group relative mt-4 inline-flex items-center gap-3 overflow-hidden rounded-xl border border-[#79808f] px-6 py-2.5 text-[1.125rem] font-medium tracking-[-0.02em]">
                  ...
                  <span className="relative z-10 text-[#0d1120] transition-colors duration-300 group-hover:text-white">
                    Know more about us
                  </span>
              ...
              <div className="lg:pt-36 pl-10">
                <div className="text-[5.25rem] font-bold leading-none tracking-[-0.06em]">
                  {yearsCount}+
                </div>
                <p className="mt-3 whitespace-nowrap text-[1.5rem] font-medium tracking-[-0.02em] text-[#2f3442]">
                  Años de experiencia
                </p>
              </div>
